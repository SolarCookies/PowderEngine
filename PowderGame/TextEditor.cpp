...
void TextEditor::HandleKeyboardInputs()
{
	...
	if (ImGui::IsWindowFocused())
	{
		...
		if (keystrokedelay.getElapsedTime().asMicroseconds() < 100000) {
		}
		else
		{
			keystrokedelay.restart();
			if (!IsReadOnly() && ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Z))
				Undo();
			else if (!IsReadOnly() && !ctrl && !shift && alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Backspace))
				Undo();
			else if (!IsReadOnly() && ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Y))
				Redo();
			else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_UpArrow))
				MoveUp(1, shift);
			else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_DownArrow))
				MoveDown(1, shift);
			else if (!alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_LeftArrow))
				MoveLeft(1, shift, ctrl);
			else if (!alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_RightArrow))
				MoveRight(1, shift, ctrl);
			else if (!alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_PageUp))
				MoveUp(GetPageSize() - 4, shift);
			else if (!alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_PageDown))
				MoveDown(GetPageSize() - 4, shift);
			else if (!alt && ctrl && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Home))
				MoveTop(shift);
			else if (ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_End))
				MoveBottom(shift);
			else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Home))
				MoveHome(shift);
			else if (!ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_End))
				MoveEnd(shift);
			else if (!IsReadOnly() && !ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Delete))
				Delete();
			else if (!IsReadOnly() && !ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Backspace))
				Backspace();
			else if (!ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Insert))
				mOverwrite ^= true;
			else if (ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Insert))
				Copy();
			else if (ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_C))
				Copy();
			else if (!IsReadOnly() && !ctrl && shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Insert))
				Paste();
			else if (!IsReadOnly() && ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_V))
				Paste();
			else if (ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_X))
				Cut();
			else if (!ctrl && shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Delete))
				Cut();
			else if (ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_A))
				SelectAll();
			else if (!IsReadOnly() && !ctrl && !shift && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Enter))
				EnterCharacter('\n', false);
			else if (!IsReadOnly() && !ctrl && !alt && ImGui::IsKeyPressed(ImGuiKey::ImGuiKey_Tab))
